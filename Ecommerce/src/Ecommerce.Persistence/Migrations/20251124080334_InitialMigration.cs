    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SubAccount = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                VirtualPrice = table.Column<double>(type: "float", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_BrandTranslation_Language_LanguageId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_PermissionsRoles", x => new { x.PermissionId, x.RoleId });
                table.ForeignKey(
                    name: "FK_PermissionsRoles_Permission_PermissionId",
                    column: x => x.PermissionId,
                    principalTable: "Permission",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_PermissionsRoles_Role_RoleId",
                    column: x => x.RoleId,
                    principalTable: "Role",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_UserTranslation", x => x.Id);
                table.ForeignKey(
                    name: "FK_UserTranslation_Language_LanguageId",
                    column: x => x.LanguageId,
                    principalTable: "Language",
                    principalColumn: "Id");
                table.ForeignKey(
                    name: "FK_UserTranslation_User_UserId",
                    column: x => x.UserId,
                    principalTable: "User",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SkuPrice = table.Column<double>(type: "float", nullable: false),
                Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                SkuValue = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                SkuId = table.Column<int>(type: "int", nullable: true),
                OrderId = table.Column<int>(type: "int", nullable: true),
                Quantity = table.Column<int>(type: "int", nullable: false),
                ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ProductTranslations = table.Column<string>(type: "nvarchar(max)", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_ProductSKUSnapshot", x => x.Id);
                table.ForeignKey(
                    name: "FK_ProductSKUSnapshot_Order_OrderId",
                    column: x => x.OrderId,
                    principalTable: "Order",
                    principalColumn: "Id");
                table.ForeignKey(
                    name: "FK_ProductSKUSnapshot_Product_ProductId",
                    column: x => x.ProductId,
                    principalTable: "Product",
                    principalColumn: "Id");
                table.ForeignKey(
                    name: "FK_ProductSKUSnapshot_SKU_SkuId",
                    column: x => x.SkuId,
                    principalTable: "SKU",
                    principalColumn: "Id");
            });
        ...
        migrationBuilder.CreateIndex(
            name: "IX_ProductSKUSnapshot_OrderId",
            table: "ProductSKUSnapshot",
            column: "OrderId");

        migrationBuilder.CreateIndex(
            name: "IX_ProductSKUSnapshot_ProductId",
            table: "ProductSKUSnapshot",
            column: "ProductId");

        migrationBuilder.CreateIndex(
            name: "IX_ProductSKUSnapshot_SkuId",
            table: "ProductSKUSnapshot",
            column: "SkuId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_UserTranslation_LanguageId",
            table: "UserTranslation",
            column: "LanguageId");

        migrationBuilder.CreateIndex(
            name: "IX_UserTranslation_UserId",
            table: "UserTranslation",
            column: "UserId");

        migrationBuilder.CreateIndex(
            name: "IX_VerificationCode_Email_Type",
            table: "VerificationCode",
            columns: new[] { "Email", "Type" },
            unique: true);

        migrationBuilder.CreateIndex(
            name: "IX_VerificationCode_ExpiresAt",
            table: "VerificationCode",
            column: "ExpiresAt");
